...
SERVICE_CAPS = kb_rnaseq_donwloader
SPEC_FILE = kb_rnaseq_donwloader.spec
URL = https://kbase.us/services/kb_rnaseq_donwloader
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
build-test-script:
	...
	echo 'cp -R /kb/module/lib/kb_rnaseq_donwloader/ /kb/module/work/kb/module/lib/' >> $(TEST_DIR)/$(TEST_SCRIPT_NAME) 

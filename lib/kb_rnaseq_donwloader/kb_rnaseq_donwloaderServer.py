...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_rnaseq_donwloader'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_rnaseq_donwloader.kb_rnaseq_donwloaderImpl import kb_rnaseq_donwloader  # noqa @IgnorePep8
impl_kb_rnaseq_donwloader = kb_rnaseq_donwloader(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_rnaseq_donwloader'
